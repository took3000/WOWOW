...
function getCSS()
{
        ...
        if (thehour<7)
            display = "static/css/night.css";
        else if (thehour<19)
            display = "static/css/day.css";
        else
            display = "static/css/night.css";
...
$(function(){
    ...
    rightNav += "<li><a href='index.html' target='_blank'>臻作首页</a></li>";
    rightNav += "<li><a href='' target='_blank'>刷新一下</a></li>";
    rightNav += "<hr>";
    rightNav += "<li class='qrBtn'><a>联系我</a></li>";
    rightNav += "<li class='qrBox'><img src='/images/ewm021.png' alt='微信二维码'/></li>";
    rightNav += "</ul>";
